...
for linha in range(1, 21):
    print('Linha ',linha, ': ', data_list[linha])
...
for linha in range(1, 21):
    print('Linha ',linha, ': ',data_list[linha][6])
...
answer = u"Porque existem valores em branco na coluna Gênero, tornando a quantidade de Male e Female menor que a quantidade de linhas do CSV"
